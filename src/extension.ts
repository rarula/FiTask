...
import { deleteAllTasksCommand, deleteTaskCommand, newTaskCommand, newTemplateTaskCommand, openTaskCommand } from './commands';
import { completeTaskCommand } from './commands/completeTask/completeTaskCommand';
